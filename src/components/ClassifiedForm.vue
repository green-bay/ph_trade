<template>
  <div>
    ...
    <v-dialog
      ...
      @close="addAd = false"
    >
      <form id="newAdForm" @submit="checkForm">
        <div v-if="addAdForm.errors.length">
          <b>Uzupełnij:</b>
          <ul>
        ...
        <p>
          ...
          <input id="name" v-model="addAdForm.name" type="text" name="name" />
        </p>
        <p>
        ...
        <p>
          ...
          <textarea id="desc" v-model="addAdForm.desc" name="desc" />
        </p>
        <p>
        ...
        <p>
          ...
          <input id="image" v-model="addAdForm.image" type="url" name="image" />
        </p>
